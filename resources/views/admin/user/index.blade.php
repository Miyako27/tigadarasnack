...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">List Data User C'3Daraaa</p>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($dataUser as $row)
                            <tr>
                                ...
                                <td>
                                    @if (!empty($row->avatar) && file_exists(public_path('storage/avatars/' . $row->avatar)))
                                        <img src="{{ asset('storage/avatars/' . $row->avatar) }}" alt="Avatar" width="50">
                                    @else
                                        <img src="{{ asset('storage/avatars/icon-user.png') }}" alt="Default Avatar" width="50">
                                    @endif
                                </td>
                                <td>{{ $row->name }}</td>
                                <td>{{ $row->email }}</td>
