...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">Tambahkan Data User C'3Daraaa</p>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="nama" type="text" name="name" placeholder="Masukkan Nama">
                    </div>
                </div>
