...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('user.list') }}" class="btn btn-sm btn-secondary text-white d-inline-flex align-items-center">
                Kembali
            </a>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="mt-2">
                        ...
                        @if (!empty($dataUser->avatar))
                            <!-- Jika avatar ada -->
                            <img src="{{ asset('storage/avatars/' . $dataUser->avatar) }}" alt="Foto Profil"
                                class="img-thumbnail" width="100">
                        @else
                            <!-- Jika avatar kosong -->
                            <img src="{{ asset('storage/avatars/icon-user.png') }}" alt="Default Avatar"
                                class="img-thumbnail" width="100">
                        @endif
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select mb-0" id="role" name="role" aria-label="Role select example">
                        ...
                        <option value="SuperAdministrator" {{ $dataUser->role == 'SuperAdministrator' ? 'selected' : '' }}>
