                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    ...
                    <tbody>
                        ...
                        @foreach ($dataGaleri as $row)
                            <tr>
                                <td>{{ ($dataGaleri->currentPage() - 1) * $dataGaleri->perPage() + $loop->iteration }}</td>
                                <td>
                                    <img src="{{ asset('storage/galeri/' . $row->galeri) }}" alt="galeri" width="70">
                                </td>
                                <td>
                                    <a href="{{ route('galeri.edit', $row->galeri_id) }}" class="btn btn-warning btn-sm">
                                    ...
                                    <a href="{{ route('galeri.destroy', $row->galeri_id) }}" class="btn btn-danger btn-sm">
                                        <svg class="icon icon-xs me-2" data-slot="icon" fill="none" stroke-width="1.5"
                                            stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                            aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round"
