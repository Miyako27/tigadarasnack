        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active">Form Data Pelanggan</li>
                </ol>
            </nav>
            <h2 class="h4">Data Pelanggan</h2>
            <p class="mb-0">Tambahkan Data Pelanggan C'3Daraaa</p>
        </div>
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="first_name" type="text" name="first_name"
                            placeholder="Masukkan Nama Depanmu">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="last_name" type="text" name="last_name"
                            placeholder="Masukkan Nama Belakangmu">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="email" type="email" name="email"
                            placeholder="nama@company.com" required="">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="form-group">
