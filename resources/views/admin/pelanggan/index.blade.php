...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">List Data Pelanggan C'3Daraaa</p>
        </div>
            ...
            <div class="mb-0">
                <form method="GET" action="{{ route('pelanggan.list') }}">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select name="birthday" onchange="this.form.submit()" class="form-select">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    @if (request('search'))
                                        <a href="{{ url()->current() }}"
                                            class="btn btn-outline-danger ml-3"id="clear-search">Clear</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0">BIRTHHDAY</th>
